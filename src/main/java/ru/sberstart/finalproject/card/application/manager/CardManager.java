...
import ru.sberstart.finalproject.card.domain.states.CardStateFactory;
...
public class CardManager {
    ...
    public Card customizeCard(CardCustomizingDTO cardCustomizingDTO) {
        return new Card.Builder()
                ...
                .withCardSecretId(cardCustomizingDTO.getCardSecretId())
                .withNumber(generateCardNumber(cardCustomizingDTO.getBankId()))
     ...
     */
    private static String generateCardNumber(UUID bankUUID) {
